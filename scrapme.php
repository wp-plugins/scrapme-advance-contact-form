...
<form method="post" action="options.php">
    ...
    <table class="form-table">
        ...
        <td><input type="text" maxlength="32" style="width: 300px;" name="scrapme_api_key" value="<?php echo esc_attr( get_option('scrapme_api_key') ); ?>" /></td>
        </tr>
        
    </table>
    <div>API Key is 32 bit long. Please do not enter any special characters or space in the key.</div>
    <?php submit_button(); ?>
	<div style="padding: 4px;">You can get the API key by registering from <a href="http://scrap.me/register.php" target="_blank" style="text-decoration: none">http://scrap.me/register.php</a>. To see a live demo on your website visit <a href="http://scrap.me/show_demo.html" target="_blank" style="text-decoration: none">Demo Page</a></div>
</form>
</div>
<?php } ?>